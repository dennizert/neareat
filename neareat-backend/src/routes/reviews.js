...
const { reviewCreateSchema, reviewUpdateSchema } = require('../validation/schemas');
...
router.put('/:reviewId', authenticate, userRateLimit, validate(reviewUpdateSchema), updateReview);
