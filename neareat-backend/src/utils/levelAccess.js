...
const LEVEL_ACCESS = {
  1: { maxReservationsPerMonth: 0,    aiPerDay: 1,    canCreateLists: false, favoritesLimit: 5,    canSuggestRestaurant: false, reservationPriority: 0, recommendationsPerDay: 1 },
  2: { maxReservationsPerMonth: 1,    aiPerDay: 5,    canCreateLists: true,  favoritesLimit: 15,   canSuggestRestaurant: false, reservationPriority: 0, recommendationsPerDay: 3 },
  3: { maxReservationsPerMonth: null, aiPerDay: 10,   canCreateLists: true,  favoritesLimit: 30,   canSuggestRestaurant: true,  reservationPriority: 1, recommendationsPerDay: 10 },
  4: { maxReservationsPerMonth: null, aiPerDay: 20,   canCreateLists: true,  favoritesLimit: 50,   canSuggestRestaurant: true,  reservationPriority: 2, recommendationsPerDay: 20 },
  5: { maxReservationsPerMonth: null, aiPerDay: null, canCreateLists: true,  favoritesLimit: null, canSuggestRestaurant: true,  reservationPriority: 3, recommendationsPerDay: null },
};
