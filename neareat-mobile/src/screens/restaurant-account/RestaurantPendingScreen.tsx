...
const styles = StyleSheet.create({
  ...
  reasonCard: {
    backgroundColor: '#FEF2F2', borderRadius: 14, padding: 16, width: '100%', marginBottom: 20,
  ...
  logoutBtn: {
    backgroundColor: '#EF4444', borderRadius: 12, paddingHorizontal: 32, paddingVertical: 14, marginTop: 8,
  },
