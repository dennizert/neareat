...
function makeStyles(C: Colors) {
  return StyleSheet.create({
    ...
    sentBadge: { backgroundColor: C.successSurface, borderRadius: 12, paddingHorizontal: 20, paddingVertical: 10, marginBottom: 8 },
    sentBadgeText: { color: C.success, fontWeight: '600' },
